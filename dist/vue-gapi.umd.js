...
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('secure-ls')) :
  typeof define === 'function' && define.amd ? define(['exports', 'secure-ls'], factory) :
  (global = global || self, factory(global.VueGapi = {}, global.SecureLS));
}(this, (function (exports, SecureLS) { 'use strict';

  SecureLS = SecureLS && Object.prototype.hasOwnProperty.call(SecureLS, 'default') ? SecureLS['default'] : SecureLS;
  ...
  var GoogleAuthService = /*#__PURE__*/function () {
    ...
    _createClass(GoogleAuthService, [{
      key: "_expiresAt",
      value: function _expiresAt(authResult) {
      ...
      key: "_setStorage",
      value: function _setStorage(authResult) {
      ...
      key: "_setOfflineAccessCode",
      value: function _setOfflineAccessCode(authResult) {
        if (authResult.code) {
      ...
      key: "_setSession",
      value: function _setSession(response) {
      ...
      key: "getOfflineAccessCode",
      value: function getOfflineAccessCode() {
        return this.offlineAccessCode;
      }
    }, {
      key: "grantOfflineAccess",
      value: function grantOfflineAccess(event) {
        if (!this.authInstance) throw new Error('gapi not initialized');
        return this.authInstance.grantOfflineAccess().then(this._setOfflineAccessCode.bind(this));
      }
    }, {
      key: "login",
      value: function login(event) {
        ...
        return new Promise(function (res, rej) {
          this$1.authInstance.signIn().then(function (response) {
          ...
          return regenerator.wrap(function _callee$(_context) {
            while (1) {
              switch (_context.prev = _context.next) {
                ...
                case 2:
                  GoogleUser = this.authInstance.currentUser.get();
                  _context.next = 5;
      ...
      value: function isAuthenticated() {
        var expiresAt = parseInt(ls.get('gapi.expires_at'));
      ...
      key: "listenUserSignIn",
      value: function listenUserSignIn(callback) {
        if (!this.authInstance) throw new Error('gapi not initialized');
  ...
  var _grantOfflineAccess = googleAuthService.grantOfflineAccess,
      getOfflineAccessCode = googleAuthService.getOfflineAccessCode,
      _login = googleAuthService.login,
      _logout = googleAuthService.logout,
  ...
  var VueGapi = {
    install: function install(Vue, clientConfig) {
      ...
      var resolveAuth2Client = function resolveAuth2Client(resolve, reject) {
        gapiPromise.then(function (_) {
          ...
          if (!gapi.auth) {
            gapi.load('client:auth2', function () {
              Vue.gapiLoadClientPromise = gapi.client.init(clientConfig).then(function () {
      ...
      Vue.prototype.$gapi = {
        getGapiClient: function getGapiClient() {
          return new Promise(function (resolve, reject) {
        ...
        grantOfflineAccess: function grantOfflineAccess() {
          return Vue.prototype.$gapi.getGapiClient().then(_grantOfflineAccess);
        },
        ...
        listenUserSignIn: function listenUserSignIn(callback) {
          return Vue.prototype.$gapi.getGapiClient().then(function () {
            return _listenUserSignIn(callback);
          });
        },
        isSignedIn: function isSignedIn() {
          return Vue.prototype.$gapi.getGapiClient().then(_isSignedIn);
        },
